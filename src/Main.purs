...
main = launchAff $ do
  ...
  let addMessagesListener' = addMessagesListener bot
  let interval' = interval (30 * 60 * 1000) master
  let runTorscraper' = runTorscraper torscraperPath
  let sendMessage' = sendMessage bot
  let handleRequests = runTorscraper' sendMessage'

  liftEff' $ addMessagesListener' $ handleRequests
  liftEff' $ interval' $ handleRequests
